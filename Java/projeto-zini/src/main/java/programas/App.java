...
//        }
        TimerTask InsertLeitura = new TimerTask() {
            ...
            public void run() {
                ...
                Integer idComputador = 75;
                Integer idMemoria = 112;
                Integer idProcessador = 113;
                Integer idDisco = 114;
        ...
        try {
                        ...
                        ConexaoAzure.jdbcTemplate.update("insert into tbLeituras values ( ?, ?, ?, ?)",
                                data.getDataHora(), idComputador, idMemoria, deci.format(memoria));
                    ...
                    case 2:
                        ...
                        ConexaoAzure.jdbcTemplate.update("insert into tbLeituras values ( ?, ?, ?, ?)",
                                data.getDataHora(), idComputador, idProcessador, deci.format(cpu));
                    ...
                    case 3:
                        ...
                        ConexaoAzure.jdbcTemplate.update("insert into tbLeituras values ( ?, ?, ?, ?)",
                                data.getDataHora(), idComputador, idDisco, deci.format(disco));
